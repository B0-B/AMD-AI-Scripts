...
def show (results: dict[str, int|float|str]) -> None:
    ...
    print("---------------- TPOT Statistics ----------------")
    print("Mean TPOT (ms/token):             ", round(results['tpot_mean'], 3))
    print("Median TPOT (ms/token):           ", round(results['tpot_median'], 3))
    print("P99 TPOT (ms/token):              ", round(results['tpot_p99'], 3))
    print("----------------- ITL Statistics ----------------")
    print("Mean ITL (ms):                    ", round(results['itl_mean'], 3))
    print("Median ITL (ms):                  ", round(results['itl_median'], 3))
    print("P99 ITL (ms):                     ", round(results['itl_p99'], 3))
